    ...
    return (
        <nav className={styles.navbar}>
            <button
                ...
                {isMenuOpen ? <span><svg width="18" height="15" viewBox="0 0 18 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1 7.5L17 7.5" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" />
                    <path d="M1 14L17 14" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" />
                    <path d="M1 1L17 1" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" />
                </svg>
                </span>
                    :
            ...
            <div className={styles.navbarTop}>
                ...
                <div className={styles.navIcons}>
                    <ul className={styles.iconsList}>
                        ...
                        <li className={`${styles.language} ${styles.desktopOnly}`}>
                            <span>ENG</span>
                ...
                <div className={styles.mobileExtra}>
                    ...
                    <div className={styles.languageMobile}>
                        ...
                        <div className={styles.langSelector}>
                            <span>ENG</span>
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M2.72125 5.9949L7.06792 10.3416C7.58125 10.8549 8.42125 10.8549 8.93458 10.3416L13.2813 5.9949" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" />
                            </svg>
                        </div>
                    </div>
                </div>
